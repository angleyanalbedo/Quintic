...
namespace Quintic.Wpf.ViewModels
{
    public class ToolbarViewModel : INotifyPropertyChanged
    {
        ...
        public ToolbarViewModel(ICommand saveProjectCommand, ICommand openProjectCommand, ICommand exportCsvCommand, ICommand exportStCommand, ICommand exportPdfCommand, ICommand showAnalysisCommand, ICommand undoCommand, ICommand redoCommand)
        {
